...
<template>
    <div class="mb-2">
        ...
        <div class="flex flex-row justify-between rounded-b-md w-full px-2 py-1 bg-gray-200 dark:bg-gray-700 dark:text-gray-50 cursor-default"
            v-if="collapsed">
            <small class="font-medium indent-4" v-if="task.description != null && task.description != ''">
                {{ task.description }}
            </small>
            <small class="font-medium indent-4 text-gray-500 italic" v-else>
                No se ha agregado descripción
            </small>
        </div>
    </div>
